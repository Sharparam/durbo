...
class TgSyncer:
    ...
    async def send_text(self, text: str, reply_to=None, file_paths=None) -> List[tl.types.Message]:
        ...
        if file_paths:
            for file_path in file_paths:
                ...
                msg = await self._client.send_message(self._group_id, text, reply_to=reply_to, file=file_path)
                sent_messages.append(msg)
        else:
            msg = await self._client.send_message(self._group_id, text, reply_to=reply_to)
            sent_messages.append(msg)
